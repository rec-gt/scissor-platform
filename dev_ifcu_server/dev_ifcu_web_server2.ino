...
void updateRowByKey(String id, String onOff, String mode, String speed, String setTemp) {
...
void handleDeviceGet() {
  ...
  if (server.hasArg("id") && server.hasArg("onOff") && server.hasArg("mode") && server.hasArg("speed") && server.hasArg("setTemp")) {
    ...
    // modify database
    updateRowByKey(id, onOff, mode, speed, setTemp);
