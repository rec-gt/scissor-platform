...
void loop() {
  ...
  displayOLED.draw(random(256), random(256), random(20000), random(20000), random(20000), random(20000), random(20000), random(20000), random(20000), random(20000), random(20000), random(20000), random(20000), random(20000));
  delay(1000);
}
