...
void overWhelmingDisplay() {
  String strArr[] = { "STR_LSAKJJHL_1;STR_LSAKJJHL_2;STR_LSAKJJHL_3", "STR_SAIOPIDUSS_2", "STRAS:ODJ_STESS_3", "STR_STSDAASESS_4", "STRASDSD_STESS_5", "STR_STASDSADESS_6", "STRDGDFS_STESS_7", "STR_STFGFGESS_8", "STRSGDSFG_STESS_9", "STR_STEFGDFGSS_10", "STR_STFDGDFGFDGESS_11", "ASDSFDSSDGDDF", "IOASDOIASJFOIJ", "IUAESFAIUD" };
