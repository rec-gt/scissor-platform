...
enum IOT_CONN_STATE {
  ...
  /* === State Initiation === */
  IOT_CONN_WAITING_RESET,
  IOT_CONN_WAITING_RESET_HARDWARE,
  IOT_CONN_FINISH_RESET_HARDWARE,
  IOT_CONN_WAITING_RESET_SOFTWARE,
  IOT_CONN_FINISH_RESET_SOFTWARE,
  IOT_CONN_FINISH_RESET,

  IOT_CONN_WAITING_ASK_MODEL,
  IOT_CONN_FINISH_ASK_MODEL,
