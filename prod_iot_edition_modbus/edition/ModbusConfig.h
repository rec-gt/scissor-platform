...
constexpr uint16_t MB_SERIAL_CONFIG = SERIAL_8N1;  // e.g., SERIAL_8E1, SERIAL_8N1
...
public:
  ...
  void readModbusData(void) {
    ...
    uint8_t endIdx = startIdx + MB_DATA_BATCH_SIZE + 1;      // e.g., 21, 41, 61, 81, ...
